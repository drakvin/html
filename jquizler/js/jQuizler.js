        ...
        jQuizler: function(questions) {
            ...
            return this.each(function(){
                ...
                $.each(questions, function(index, question){
                    ...
                    html += "<div class=\"notice alert alert-info\">Izvēlēties atbildi</div>";

                    if (index != 0) {
                        html += "<button class=\"prev btn btn-info\"><i class='icon-arrow-left icon-white'></i> Iepriekšējais</button>";
                    }

                    if (index != questions.length-1) {
                        html += "<button class=\"next btn btn-success\">Nākošais <i class='icon-arrow-right icon-white'></i></button>";
                        html += "<div style=\"clear:both\"></div>";

                    } else {
                        html += "<button class=\"final btn btn-success\">Rezultāts <i class='icon-ok icon-white'></i></button>";
                        html += "<div style=\"clear:both\"></div>";
                    }
                ...
                $(".final").click(function(e){
                    ...
                    if (userAnswer.index() == -1 && !reviewQuiz) {
                        ...
                        var resultHTML = "<h3 style=\"text-align: center\">REZULTĀTI</h3>";
                        ...
                        $.each(questions, function(index, question){
                            ...
                            if (element.index() == question.correct) {
                                ...
                                buttonsHTML += "<button class=\"btn btn-success\"><i class='icon-ok-sign icon-white'></i> Jautājums " + (index+1) + "</button>";
                                rightAnswers++;
                            } else {
                                element.removeClass("btn-info");
                                element.addClass("btn-danger");

                                buttonsHTML += "<button class=\"btn btn-danger\"><i class='icon-remove-sign icon-white'></i> Jautājums " + (index+1) + "</button>";
                        ...
                        resultHTML += "<p style=\"margin: 14px 0px\">Jūs atbildējat uz  " + Math.round(((rightAnswers * 100) / questions.length) * 100) / 100 + "% jautājumiem.</p>";
                        resultHTML += buttonsHTML;
                        resultHTML += "<p style=\"margin-top:25px; text-align: center\"><button class=\"btn btn-large tostart\">Apskatīt jautājumus</button></p>";
